    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-black text-slate-900 tracking-tight mt-1">Bookings & Passenger Roster</h1>
              ...
              {bookings.map((b) => (
                <tr key={b.id} className="hover:bg-slate-50/80 transition-colors">
                  <td className="px-5 py-4">
                    <span className="font-mono font-bold text-blue-600 block">{b.bookingNumber}</span>
                  ...
                  <td className="px-4 py-4">
                    <div className="font-bold text-slate-900">
                      {b.passengers[0]?.passengerName || 'Candidate'}
                    </div>
                    <div className="text-[11px] text-slate-500 font-mono mt-0.5">
                      {b.passengers[0]?.passengerPhone || '—'}
                  ...
                  <td className="px-4 py-4">
                    <div className="font-semibold text-slate-900 truncate max-w-xs">
                      {b.trip.route.routeName}
                    </div>
                    <div className="text-[11px] text-slate-500 font-mono mt-0.5">
                      {b.trip.tripCode} ({b.trip.bus.busNumber})
                    </div>
                  </td>
