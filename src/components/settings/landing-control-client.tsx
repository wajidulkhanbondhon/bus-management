...
export function LandingControlClient() {
  ...
  const resetConfig = async () => {
    ...
    try {
      await fastApiClient.saveLandingSettings({
        company_name: DEFAULT_LANDING_CONFIG.companyName,
        tagline: DEFAULT_LANDING_CONFIG.tagline,
        helpline_number: DEFAULT_LANDING_CONFIG.helplineNumber,
        whatsapp_number: DEFAULT_LANDING_CONFIG.whatsappNumber,
        banner_enabled: DEFAULT_LANDING_CONFIG.bannerEnabled,
        banner_message: DEFAULT_LANDING_CONFIG.bannerMessage,
        map_animation_enabled: DEFAULT_LANDING_CONFIG.mapAnimationEnabled
      });
    } catch {}
    setHasChanges(false);
