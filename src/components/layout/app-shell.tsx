...
export function AppShell({ children, currentUser }: AppShellProps) {
  ...
  return (
    <div suppressHydrationWarning className="flex w-full min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      {/* ── Mobile Bottom Navigation Bar (Staff / ERP Mode) ── */}
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-t border-slate-200 dark:border-slate-800 px-3 py-2 flex items-center justify-around shadow-lg">
        <Link
          href="/dashboard"
          className={cn(
            'flex flex-col items-center gap-0.5 text-[10px] font-bold py-1 px-2 rounded-xl transition-colors',
            pathname === '/dashboard' ? 'text-blue-600 dark:text-blue-400' : 'text-slate-500 hover:text-slate-800 dark:hover:text-slate-200'
          )}
        >
        ...
        <Link
          ...
          className={cn(
            'flex flex-col items-center gap-0.5 text-[10px] font-bold py-1 px-2 rounded-xl transition-colors',
            pathname === '/bookings' ? 'text-blue-600 dark:text-blue-400' : 'text-slate-500 hover:text-slate-800 dark:hover:text-slate-200'
          )}
        >
        ...
        >
          <div className="w-11 h-11 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/40 border-2 border-white dark:border-slate-900">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
              <path d="M5 12h14M12 5v14" />
            </svg>
          </div>
          <span className="text-[10px] font-bold text-blue-600 dark:text-blue-400">নতুন বুকিং</span>
        </Link>
        ...
        <Link
          ...
          className={cn(
            'flex flex-col items-center gap-0.5 text-[10px] font-bold py-1 px-2 rounded-xl transition-colors',
            pathname.startsWith('/trips') ? 'text-blue-600 dark:text-blue-400' : 'text-slate-500 hover:text-slate-800 dark:hover:text-slate-200'
          )}
        >
          <Bus className="w-4 h-4" />
          <span>বাস শিডিউল</span>
        </Link>
        ...
        <Link
          ...
          className={cn(
            'flex flex-col items-center gap-0.5 text-[10px] font-bold py-1 px-2 rounded-xl transition-colors',
            pathname.startsWith('/reports') || pathname.startsWith('/sales') ? 'text-blue-600 dark:text-blue-400' : 'text-slate-500 hover:text-slate-800 dark:hover:text-slate-200'
          )}
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
