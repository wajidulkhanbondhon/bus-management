...
def log_security_event(ip_address: str, event_type: str, details: str, severity: str = "LOW"):
    """
...
def process_warning_timeouts():
    ...
    try:
        ...
        warnings = db.query(BlockedIP).filter(
            BlockedIP.is_blocked == False,
            BlockedIP.blocked_by == "SECURITY_AI",
            BlockedIP.updated_at == None, # Assuming updated_at changes when admin pardons
